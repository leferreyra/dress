...
class DetalleClienteFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.texto_dni = wx.StaticText(self.panel_1, -1, "DNI")
        ...
        self.texto_paga_con = wx.TextCtrl(self.panel_2, -1, "", style=wx.TE_PROCESS_ENTER)
        ...
        self.boton_cerrar = wx.Button(self.panel_2, -1, "Cerrar")
    ...
    def __set_properties(self):
        # begin wxGlade: DetalleClienteFrame.__set_properties
        self.SetTitle("frame_1")
        self.SetSize((657, 559))
        ...
        self.texto_dni.SetMinSize((80, 18))
    ...
    def __do_layout(self):
        # begin wxGlade: DetalleClienteFrame.__do_layout
        ...
        sizer_3.Add(self.label_cliente, 0, wx.LEFT, 7)
        grid_sizer_2.Add(self.label_dni, 0, wx.LEFT | wx.TOP, 10)
        grid_sizer_2.Add(self.texto_dni, 0, wx.LEFT | wx.TOP, 10)
        grid_sizer_2.Add(self.label_nombre, 0, wx.LEFT | wx.TOP, 10)
        grid_sizer_2.Add(self.texto_nombre, 0, wx.LEFT | wx.RIGHT | wx.TOP | wx.EXPAND, 8)
        ...
        sizer_3.Add(grid_sizer_3_copy, 1, wx.EXPAND, 0)
        grid_sizer_3_copy_copy.Add(self.label_telefono, 0, wx.LEFT | wx.TOP, 10)
        grid_sizer_3_copy_copy.Add(self.texto_telefono, 0, wx.LEFT | wx.RIGHT | wx.TOP, 8)
        grid_sizer_3_copy_copy.AddGrowableCol(1)
        sizer_3.Add(grid_sizer_3_copy_copy, 1, wx.EXPAND, 0)
        ...
        grid_sizer_7.Add(self.boton_cerrar, 0, wx.ALL, 4)
...
# end of class DetalleClienteFrame
