...
class MainFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.texto_buscar_prendas = wx.TextCtrl(self.notebook_1_pane_1, -1, "Buscar...", style=wx.TE_PROCESS_ENTER)
        ...
        self.boton_nuevo_prendas = wx.Button(self.notebook_1_pane_1, -1, "&Nueva")
        self.boton_agregar_quitar = wx.Button(self.notebook_1_pane_1, -1, "Agregar o\nquitar del\ncarrito")
        ...
        self.texto_buscar_clientes = wx.TextCtrl(self.notebook_1_pane_2, -1, "Buscar...", style=wx.TE_PROCESS_ENTER)
